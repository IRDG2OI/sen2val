            ...
            md_dynamic_content = pandas.concat([md_dynamic_content, pandas.DataFrame(
                {
                    ...
                    # trouver des dates dans les données tuiles (date du fichier img etc)
...
def csv_tuile_indice():
    ...
    try:
        create_metadata_csv_file(indices_tiles, 'METADATA_SEN2CHAIN',
                                 'download/METADATA_SEN2CHAIN_tuiles-indices_static.csv')
