...
# --TODO-- optimiser le parcours des fichiers avec la regex. Là, parcourue une fois par listdir_attr + test sur chaque item par la regex. Faire le filtre dès list_dir
